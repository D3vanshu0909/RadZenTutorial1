...
namespace RadZenTutorial1.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<RadZenTutorial1.Models.ApplicationUser> users;
        protected RadzenDataGrid<RadZenTutorial1.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(RadZenTutorial1.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(RadZenTutorial1.Models.ApplicationUser user)
        {
            try
            {
